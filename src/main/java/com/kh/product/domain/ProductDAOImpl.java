...
public class ProductDAOImpl implements ProductDAO {
  ...
  public Long save(Product product) {
    ...
    sql.append("insert into product(product_id,pname,pcount,pprice) ");
    ...
    jt.update(new PreparedStatementCreator() {
      ...
      public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
        ...
        pstmt.setLong(2, product.getPcount());
        pstmt.setLong(3, product.getPprice());
        return pstmt;
      }
    },keyHolder);
  ...
  public List<Product> findAll() {
    StringBuffer sql = new StringBuffer();
    sql.append("select product_id,pname,pcount,pprice ");
  ...
  public int update(Long productId, Product product) {
    ...
    int affectedRow = jt.update(sql.toString(),
        product.getPname(), product.getPcount(), product.getPprice(),productId);
    return affectedRow;
  }
